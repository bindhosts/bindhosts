...
- **APatch**
  ...
  - 兼容 Adaway
  - 隐藏: 排除修改 + [ZygiskNext](https://github.com/Dr-TSNG/ZygiskNext) 的仅还原挂载
- **Magisk**
  - magic mount
  - 兼容 Adaway
...
- 在有使用能对 denylist 处理 umount 的情况下使用。
...
> _"Injection is much better than mount in this usecase"_ <br> _"在这种情况下，注入比挂载要好得多"_ <div align="right"><em>-- aviraxp</em></div>
...
> _"openredirect will take more CPU cycle as well.."_ <br> _"openredirect 也会消耗更多的CPU资源…"_ <div align="right"><em>-- simonpunk</em></div>
...
- ksud 协助 umount 的 mount --bind
- 仅 KernelSU 可用
- 需要 KernelSU 版本大于 22106
- 兼容 AdAway
- 隐藏：由 KernelSU 处理 umount
