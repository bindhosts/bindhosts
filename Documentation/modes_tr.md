...
- **APatch**
  ...
  - Adaway ile uyumlu
  - Gizleme: Modifikasyonları hariç tut + [ZygiskNext](https://github.com/Dr-TSNG/ZygiskNext)'in "yalnızca bağlantıyı kes" özelliği
- **Magisk**
  - magic mount
  - Adaway ile uyumlu
...
- Adaway ile uyumlu
- Gizleme: Bağlantı kesmeyi SuSFS yönetir
...
- bilinen bir "denylist işleyicisi" bulunduğunda seçilir.
- Adaway ile uyumlu
...
- mount --bind + çekirdek destekli bağlantı kesme
- Sadece KernelSU
- KernelSU 22106+ gerektirir
- AdAway uyumlu
- Gizleme: Bağlantı kesmeyi KernelSU yönetir.
